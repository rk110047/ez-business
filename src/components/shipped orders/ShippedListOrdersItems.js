			...
			return(
				...
				<View style={{backgroundColor:"#fff",padding:10,margin:10,elevation:3}}>
					<View style={{flexDirection:"row",padding:10,justifyContent:"center"}}>
						<Text style={{fontSize:20, color:"#17baa1"}}>Order ID:</Text>
						<Text style={{fontSize:20 , textDecorationLine:"underline" , fontWeight:"bold" , color:"orange"}}>{this.state.data.order_id}</Text>
					</View>
