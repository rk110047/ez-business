...
import {View , Text , Picker , Button , TextInput , TouchableOpacity , ActivityIndicator , AsyncStorage , ScrollView , Image , ImageBackground} from 'react-native';
...
export default class CreateShopProfile extends React.Component{
    ...
    categoriesRetrieveHandler = async()=>{
      let res = await axios.get("http://100.25.15.160/shops/shopcat/LC/")
	...
	profileCreateHandler = async() => {
     this.setState({loading:true})
      ...
      console.log(newData)
      let response = await fetch("http://100.25.15.160/shops/create-shop-profile/", {
         method: 'POST',
         headers: {
