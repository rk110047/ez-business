...
export default class CreateCollectorProfile extends React.Component{
	...
	profileCreateHandler = async() => {
     this.setState({loading:true})
      ...
      let response = await fetch("http://100.25.15.160/collector/profile/create/", {
         method: 'POST',
         headers: {
      ...
      this.setState({loading:false})
      AsyncStorage.removeItem('collectortoken')
